...
class TColor {
  static Color get primary => const Color(0x0000007E);
  ...
  static const Color primaryBg = Color(0xFF7E3FF2);
  static Color get secondary => const Color(0xFF7E3FF2);
  static Color get secondary50 => const Color(0xffFFA699);
  static Color get secondary0 => const Color(0xffFFD2CC);
  static Color get black => const Color(0xffFFD2CC);
  static Color get secondaryG => const Color.fromARGB(255, 0, 8, 7);
  ...
  static Color get yellow => const Color.fromARGB(255, 203, 190, 18);
