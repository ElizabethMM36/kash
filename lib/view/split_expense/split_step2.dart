    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          // 3. Method
          Text("How do you want to split?", style: TextStyle(color: TColor.gray30, fontSize: 14)),
          const SizedBox(height: 10),
          Wrap(
            spacing: 10,
            runSpacing: 10,
            children: methods.map((s) => _buildChoiceChip(s, method, (val) {
              setState(() {
                method = val;
              });
            })).toList(),
          ...
          Row(
            ...
            children: [
              Text("Are you included in this split?", style: TextStyle(color: TColor.white, fontSize: 16)),
              Switch(
                value: !excludeSelf, 
                onChanged: (val) {
                   setState(() {
